...
elem.send_keys("frontal face asian")
...
def fetch_detail_url():
    ...
    for idx,p in enumerate(params,1):
        # 다운받을 폴더경로 입력
        urllib.request.urlretrieve(p, "c:/googleimg/" + str(idx) + ".jpg")
...
#구글 웹크롤링(기간지정해서 크롤링하는 방법)

from icrawler.builtin import GoogleImageCrawler
import os
download_dir="C:\\googleimg"
...
google_crawler.crawl(keyword='asia man face',
