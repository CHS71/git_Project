...
class Dataset(object):
    ...
    def read(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE, img_channels=3, nb_classes=2):
        ...
        X_valid, X_test, y_valid, y_test = train_test_split(X_train, y_train, test_size=0.15, random_state=random.randint(0, 100))
...
class Model(object):
    ...
    def train(self, dataset, batch_size=100, epochs =15, data_augmentation=False):
